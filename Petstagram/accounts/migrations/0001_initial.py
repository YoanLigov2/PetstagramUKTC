    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_pic', models.ImageField(upload_to='profile_picture', validators=[Petstagram.photos.validators.validate_file_size])),
                ('gender', models.CharField(choices=[('Мъж', 'Мъж'), ('Жена', 'Жена'), ('Не показвай', 'Не показвай')], default='Не показвай', max_length=11)),
